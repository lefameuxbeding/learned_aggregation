...
CUDA_VISIBLE_DEVICES=0 python src/main.py         --config config/meta_test/image-mlp-fmst_fedlagg-adafac.py         --name_suffix _bs1024_s_sp_final         --local_batch_size 1024         --test_project mup-meta-testing         --task vit-w2048-d3_imagenet-32x32x3         --optimizer small_fc_mlp         --wandb_checkpoint_id eb-lab/mup-meta-training/dcjjqqyt         --num_runs 4         --num_inner_steps 5000         --needs_state         --adafac_step_mult 0.001         --gradient_accumulation_steps 1         --test_interval 100         --use_bf16 --seed 20
