...
def truncated_unroll_one_step_lagg(
    task_family: tasks_base.TaskFamily,
    learned_opt: lopt_base.LearnedOptimizer,
    trunc_sched: truncation_schedule.TruncationSchedule,
    theta: lopt_base.MetaParams,
...
def truncated_unroll_one_step_vec_theta_lagg(
    task_family: tasks_base.TaskFamily,
    learned_opt: lopt_base.LearnedOptimizer,
    trunc_sched: truncation_schedule.TruncationSchedule,
    theta: lopt_base.MetaParams,
...
@gin.configurable
class VectorizedLAggTruncatedStep(
    ...
    def unroll_step(
        ...
        fn = (
            truncated_unroll_one_step_vec_theta_lagg
            if theta_is_vector
            else truncated_unroll_one_step_lagg
        )
