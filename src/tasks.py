...
def My_Conv_Cifar10_32x64x64(batch_size):
    ...
    datasets = image.cifar10_datasets(batch_size=batch_size, prefetch_batches=1)
    return _ConvTask(base_model_fn, datasets)
...
def My_ImageMLP_FashionMnist_Relu128x128(batch_size):
    ...
    datasets = image.fashion_mnist_datasets(batch_size=batch_size, prefetch_batches=1)
