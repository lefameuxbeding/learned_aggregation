...
@gin.configurable
class FedAdafacMLPLOptDLLR(lopt_base.LearnedOptimizer):
    ...
    def _mod(
        ...
        for wi, w in enumerate([self._hidden_size] * self._hidden_layers + [3]):
        ...
        # print("return new_p, new_llr")
        return [new_p, new_llr]
