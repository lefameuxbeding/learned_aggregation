...
python ./src/main.py --config ./config/meta_train/meta_train_fedlopt-adafac32_image-mlp-fmst.py --num_local_steps 32  --name_suffix z  --use_pmap --num_devices 2 # --num_runs 9
